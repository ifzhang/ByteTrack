...
class LoadImages:  # for inference
    def __init__(self, path, img_size=640, video_start_idx=0):
    ...
    def __next__(self):
        ...
        return path, img, img0, self.cap, self.frame, self.count
...
class LoadWebcam:  # for inference
    ...
    def __next__(self):
        ...
        return img_path, img, img0, None, None, None
...
class LoadStreams:  # multiple IP or RTSP cameras
    def __init__(self, sources='streams.txt', img_size=640):
        ...
        for i, s in enumerate(sources):
            ...
            if self.imgs[i] is not None:
                self.imgs[i] = self.imgs[i][self.crop_factor*9:h, self.crop_factor*8:w-self.crop_factor*8]
                self.imgs[i] = cv2.resize(self.imgs[i], (1280, 720))
    ...
    def __next__(self):
        ...
        return self.sources, img, img0, None, None, None
