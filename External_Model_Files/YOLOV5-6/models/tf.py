...
from models.common import C3, SPP, Bottleneck, BottleneckCSP, Concat, Conv, DWConv, Focus, autopad
...
class TFModel:
    def __init__(self, cfg='yolov5s6.yaml', ch=3, nc=None, model=None, imgsz=(640, 640)):  # model, channels, classes
