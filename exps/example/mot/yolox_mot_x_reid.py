...
class Exp(MyExp):
    ...
    def get_model(self):
        from yolox.models import YOLOPAFPN, YOLOXReID, YOLOXHeadReID
        ...
        if getattr(self, "model", None) is None:
            ...
            head = YOLOXHeadReID(self.num_classes, self.num_ids, self.reid_dim, self.width, in_channels=in_channels)
